...
vllm serve ./meta-llama/Llama-3.3-70B-Instruct --port 8888 --tensor-parallel-size 2 --max-model-len 16384 &
...
while true; do
    status=$(synthetic-data-kit -c ./synthetic-data-kit/configs/llama_config1.yaml system-check)
    echo ========================================================================
...
for folder in "${folders[@]}"; do
    ...
    (
        ...
        synthetic-data-kit -c ./configs/llama_config_api.yaml create "./data/parsed/$folder" --type qa -o "./data/generated/llama/$folder"
